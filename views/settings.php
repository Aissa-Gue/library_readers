            ...
            <div class="">
                ...
                <div class="tab-content" id="pills-tabContent">
                    <div class="tab-pane fade show active" id="pills-database" role="tabpanel">
                        ...
                        <hr>
                        <form method="post" action="<?php echo $ROOT_DIR . '/controllers/file_upload.php' ?>"
                        ...
                        <form method="post" action="<?php echo $ROOT_DIR . '/controllers/import_db.php' ?>"
                              enctype="multipart/form-data">
                            <!-- Second row -->
                            <div class="form-group row mb-3">
                                <div class="input-group">
                        ...
                        <form method="post" action="<?php echo $ROOT_DIR . '/controllers/export_db.php' ?>"
                              enctype="multipart/form-data">
                            <!-- Third row -->
                            <div class="form-group row mb-3">
                        ...
                        <!-- Forth row -->
                        <form method="post" action="<?php echo $ROOT_DIR . '/controllers/drop_db.php' ?>"
                              enctype="multipart/form-data">
                            <div class="form-group row mb-3">
                    ...
                    <div class="tab-pane fade" id="pills-accounts" role="tabpanel">
                        ...
                        <hr>
                        <form method="post" action="<?php echo $ROOT_DIR . '/controllers/editAccount.php' ?>">
                            <!-- First row -->
                            <div class="form-group row mb-3">
                                <div class="input-group">
