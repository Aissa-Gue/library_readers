...
<div class="container-fluid background_img">
    ...
    <div class="row justify-content-center">
        ...
        <div class="col-11 p-3 offset-1 rounded">
            ...
            <form action="" method="post" enctype="multipart/form-data" class="shadow rounded p-3 mt-2" style="background-color: rgba(255,255,255,0.6)">
                <!-- 1st row -->
                <div class="row">
                    <div class="col-6 p-3">
                        <div class="row">
                    ...
                    <div class="col-6 p-3">
                        <div class="row">
                            ...
                            <div class="col-md-12 text-end">
                                <button type="submit" class="btn btn-success rounded-pill py-2 mt-3" style="width: 120px"
                                        name="insert">
