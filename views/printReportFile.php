...
<body>
    ...
    <table class="table" style="margin-right: 20px; margin-left: 20px">
        <tr>
            <th class="th_date">التاريخ</th>
            <th class="th">وقت الدخول</th>
            <th class="th">وقت الخروج</th>
            <th class="th">مدة المطالعة</th>
        </tr>
        <?php
    ...
    <a href="printReport.php?soft_id=<?php echo $soft_id ?>" class="search" id="searchBtn">
