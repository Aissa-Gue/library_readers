            ...
            <div class="row">
                ...
                <div class="col-6">
                    <div class="card border-primary mb-3">
                        <div class="card-header text-center">إحصائيات الزائرين</div>
                ...
                <div class="col-6">
                    <div class="card border-primary mb-3">
                        <div class="card-header text-center">أكثر المنخرطين زيارة (السنة الحالية)</div>
                        <div class="card-body text-primary">
                            <table class="table">
                                <thead>
                                <tr>
                                ...
                                while ($row = mysqli_fetch_array($topReadersResult)) {
                                    ...
                                    <tr>
                                        ...
                                        <?php } ?>
                                        <td class="text-center text-primary fw-bold"><?php echo $row['visits'] ?></td>
                                        <td class="text-center text-success fw-bold"><?php echo $row['total_time'] ?></td>
                                    </tr>
                                <?php } ?>
                                </tbody>
                            </table>
