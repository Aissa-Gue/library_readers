...
if (isset($_FILES['db'])) {
    ...
    if (
        ...
        echo '<script>window.location.href = "../views/readers.php"</script>'; // redirect to home.php
    } else {
        echo "<script>alert('حدثت مشكلة: لم يتم إضافة قاعدة البيانات!')</script>";
        echo '<script>window.location.href = "../views/settings.php"</script>'; // redirect to home.php
    }
}